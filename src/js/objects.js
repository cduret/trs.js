var Objects = (function() {
  var to_string = function(o, indent) {
    var _to_string = function(o) {
      var obj_tostring = function(o) {
        var i, res = '{';
        for(i in o) {
          if( o.hasOwnProperty(i) ) {
            res += '"'+i+'":'+_to_string(o[i])+',';
          }
        }
    ...
    return indent?JSON.stringify(JSON.parse(_to_string(o)),null,2):
                  _to_string(o);
